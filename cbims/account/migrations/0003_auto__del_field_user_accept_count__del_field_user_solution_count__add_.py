...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.accept_count'
        db.delete_column(u'account_user', 'accept_count')

        # Deleting field 'User.solution_count'
        db.delete_column(u'account_user', 'solution_count')

        # Adding field 'User.last_login_datetime'
        db.add_column(u'account_user', 'last_login_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.answered_count'
        db.add_column(u'account_user', 'answered_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.upload_count'
        db.add_column(u'account_user', 'upload_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.accept_count'
        db.add_column(u'account_user', 'accept_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.solution_count'
        db.add_column(u'account_user', 'solution_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'User.last_login_datetime'
        db.delete_column(u'account_user', 'last_login_datetime')

        # Deleting field 'User.answered_count'
        db.delete_column(u'account_user', 'answered_count')

        # Deleting field 'User.upload_count'
        db.delete_column(u'account_user', 'upload_count')
